...
<div class="container-fluid py-4">
                ...
                <div class="card-header pb-0">
                    <div class="row">
                        <div class="col-lg-6 col-7">
                            <a href="<?= $domainURL ?>brand-product" class="btn btn-outline-primary back-btn">
    ...
    margin-bottom: 20px;overflow-x: auto;">
                        ...
                        <form id="productForm" action="<?= rtrim($domainURL, '/') . '/update-brand/' . $id ?>"
                            method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label for="name">Brand ID :</label> <b>
                                    <?= $id ?>
                                </b>
