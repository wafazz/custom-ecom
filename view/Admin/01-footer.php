...
<?php
if ($pageName == "New Product" || $pageName == "Update Product" || $pageName == "Stock Control" || $pageName == "Category - Update" || $pageName == "Category - Add & Update" || $pageName == "Brand - Update" || $pageName == "Brand - Add & Update" || $pageName == "Order - New" || $pageName == "DHL - Setting" || $pageName == "Order - Process" || $pageName == "Policy - Setting" || $pageName == 'Terms & Conditions - Setting' || $pageName == 'About Us - Setting' || $pageName == "Add New Country" || $pageName == "List Country" || $pageName == "Shipping Cost" || $pageName == "Staff List" || $pageName == "Announcement & Blog" || $pageName == "Announcement & Blog (Update)" || $pageName == "Profile" || $pageName == "J&T Setting" || $pageName == "Password" || $pageName == "Setting Image" || $pageName == "Store Setting" || $pageName == "Senangpay Setting" || $pageName == "Bayarcash Setting" || $pageName == "Slider Setting") {
